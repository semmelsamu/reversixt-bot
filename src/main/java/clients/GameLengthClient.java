...
public class GameLengthClient extends Client {
    ...
    public Move sendMove(Limit type, int limit) {
        ...
        if (!game.staticGameStats.isReachableTilesSetFinally() &&
                (double) game.gameStats.getOccupiedTilesOverall() /
                        game.staticGameStats.getReachableTiles() > 0.6) {
                game.staticGameStats.updateReachableTiles(game, limit/2);
        }
