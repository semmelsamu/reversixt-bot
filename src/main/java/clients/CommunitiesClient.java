...
//
//    /**
//     * The time in milliseconds by which we want to respond earlier to avoid disqualification
//     due to
//     * network latency.
//     */
...
//     * @param limit The amount of the limit. If depth limit, specifies the maximum depth the
//     search
//     *              tree shall be built, if time limit, specifies the maximum time the client
//     has to
...
//                    sortMoves(game, game.getRelevantMovesForCurrentPlayer(), new HashMap<>(),
//                    true);
//
...
//
//            // Evaluate phi move
//            int score = calculateScore(phi.second(), newCommunityPhi, depth - 1, alpha, beta,
//            true);
//            int result = score;
...
//        Set<Move> relevantMovesForCurrentPlayerCopy = new HashSet<>
//        (relevantMovesForCurrentPlayer);
//
...
//     * 1. The number of cutoffs the same moves achieved in other branches on the same height of
//     the
